...
def plot_homo_vs_hetero(model, param_to_vary, h, t, V_traces, pop_mean_V, V, unit_traces=False):
    plt.figure()
    ...
    if unit_traces:
        for i in range(5): plt.plot(t, V_traces[i], alpha=0.6)
